...
import LocationPinIcon from '@/assets/images/login-figma/location-pin.svg';
...
const LoginHeroImage = require('../../loginimage.png');
...
export function AuthMobileHero() {
  ...
  const speechBubbleWidth = Math.round(232 * scale);
        ...
        <View style={[styles.heroContent, { top: Math.round(28 * scale) }]}>
          ...
          >
            ...
            <View style={styles.speechBubbleRow}>
              <Text style={styles.speechText}>Welcome! Stay Anywhere, Feel at Home</Text>
              <LocationPinIcon width={8} height={8} />
            </View>
          </View>
        </View>

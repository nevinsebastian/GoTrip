...
export const VENDOR_LISTINGS_COPY = {
  ...
  deletePropertyTitle: 'Delete Not Supported',
  deletePropertyBody:
    'The backend does not support deleting listings or images yet. You can still edit prices/details, and some room types or slots can be disabled from the edit screen.',
  deletePropertyCta: 'Delete Property',
  confirmDeleteCta: 'Okay',

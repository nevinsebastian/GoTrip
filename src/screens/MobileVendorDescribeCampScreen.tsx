...
export function MobileVendorDescribeCampScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.page}>
        ...
        >
          <VendorOnboardingHero categoryId="glamping" />
      ...
      <VendorPropertyOptionSheet
        ...
        title={VENDOR_GLAMPING_DESCRIBE_COPY.placeTypeLabel}
        options={VENDOR_CAMP_PLACE_TYPES as Parameters<typeof VendorPropertyOptionSheet>[0]['options']}
      ...
      <VendorPropertyOptionSheet
        ...
        title={VENDOR_GLAMPING_DESCRIBE_COPY.spaceTypeLabel}
